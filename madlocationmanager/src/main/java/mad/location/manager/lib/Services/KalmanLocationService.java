...
public class KalmanLocationService extends Service
    ...
    class SensorDataEventLoopTask extends AsyncTask {
        ...
        private void handlePredict(SensorGpsDataItem sdi) {
            ...
            m_geoHashRTFilter.displayPoint.Latitude = loc.getLatitude();
            m_geoHashRTFilter.displayPoint.Longitude = loc.getLongitude();
        ...
        private Location locationAfterUpdateStep(SensorGpsDataItem sdi) {
            ...
            yVel = m_kalmanFilter.getCurrentYVel();
            double speed = Math.sqrt(xVel*xVel + yVel*yVel); //scalar speed without bearing
            double Bearing = sdi.getCourse();//Math.atan2(yVel,xVel);//it me
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (event.sensor.getType()) {
            case Sensor.TYPE_LINEAR_ACCELERATION:
                m_geoHashRTFilter.Acc = event.values[1];
                ...
                double course = m_geoHashRTFilter.direction;
                if(course > 180)
                {
                    course -= 360;
                }
            ...
            case Sensor.TYPE_ROTATION_VECTOR:
                ...
                m_geoHashRTFilter.direction = heading;
    ...
    public void onLocationChanged(Location loc) {
        ...
        long timeStamp;
        speed = loc.getSpeed();
        course = m_geoHashRTFilter.direction;
        if(course > 180)
        {
            course -= 360;
        }
