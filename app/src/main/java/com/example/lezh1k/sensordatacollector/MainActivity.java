        ...
        protected void onProgressUpdate(Object... values) {
            ...
            if (m_isLogging) {
                ...
                tvDistance.setText(String.format(
                        ...
                        m_geoHashRTFilter.Acc
                ));
                long[] message = new long[5];
                message[0] = Double.doubleToLongBits(m_geoHashRTFilter.displayPoint.Longitude);
                message[1] = Double.doubleToLongBits(m_geoHashRTFilter.displayPoint.Latitude);
                message[2] = Double.doubleToLongBits(m_geoHashRTFilter.speed);
                message[3] = Double.doubleToLongBits(m_geoHashRTFilter.direction);
                message[4] = Double.doubleToLongBits(m_geoHashRTFilter.Acc);

                for(int i = 0;i<5;i++)
                {
                    usbService.write(toBytes(message[i]));
                }
            } else {
